...
var Box2d, Circle, Rect, Shape, World, _Body, _BodyDef, _CircleShape, _DebugDraw, _DistanceJointDef, _Dynamic, _Fixture, _FixtureDef, _Kinematic, _MassData, _MouseAttached, _MouseJointDef, _PolygonShape, _Static, _Vec2, _World,
...
World = (function() {
  ...
  World.prototype.makeMouseJoint = function(target) {
    ...
    return this.joints.push(this.world.CreateJoint(jointDef));
  };
